...
public class UserControllerTest {
    ...
    public void shouldAddUserWhenAllAttributeCorrect() {
        ...
        assertEquals(1, userController.findAll().size(), "В списке должен быть один пользователь");
    }
    ...
    public void shouldNoAddUserWhenUserEmailIsEmpty() {
        ...
        assertEquals(0, userController.findAll().size(), "Список пользователей должен быть пустым");
    }
